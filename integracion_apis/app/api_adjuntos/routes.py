...
api_adjuntos_bp = Blueprint('api_adjuntos', __name__)
...
@api_adjuntos_bp.route('/documentos', methods=['POST'])
...
@api_adjuntos_bp.route('/files/<document_id>/<filename>')
...
@api_adjuntos_bp.route('/archivos')
