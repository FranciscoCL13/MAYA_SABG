...
documentos_blueprint = Blueprint('documentos', __name__)

KIE_SERVER_URL = Config.KIE_SERVER_URL
KIE_USERNAME = Config.KIE_USERNAME
KIE_PASSWORD = Config.KIE_PASSWORD
FILE_SERVER_PATH = Config.ARCHIVOS_BASE_DIR

@documentos_blueprint.route('/', methods=['POST'])
...
@documentos_blueprint.route('/files/<document_id>/<filename>')
...
@documentos_blueprint.route('/archivos')
def mostrar_archivos():
    ...
    for document_id in os.listdir(FILE_SERVER_PATH):
        ...
        for archivo in os.listdir(carpeta):
            link = f"/documentos/files/{document_id}/{archivo}"
